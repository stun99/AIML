...
if { [regexp -nocase "r" $flow ] } {
    ...
    create_stdcell_fillers -lib_cells "saed32hvt_c/SHFILL128_HVT saed32hvt_c/SHFILL64_HVT saed32hvt_c/SHFILL3_HVT saed32hvt_c/SHFILL2_HVT saed32hvt_c/SHFILL1_HVT"
